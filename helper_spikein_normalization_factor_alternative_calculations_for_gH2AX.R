...
# calculated using the different methods for the gamma-H2AX experiment samples.
...
names(read_counts_per_chr)[
  str_detect(read_counts_per_chr, fixed('ah4206spike-gh2ax', ignore_case=TRUE))]

# List of samples ordered correctly
files_for_calculation <- list(
  AH119=c(read_counts_per_chr[['ah119spike-gh2ax-chip_trimmed']],
          read_counts_per_chr[['ah119spike-gh2ax-inp_trimmed']]),
  AH8218=c(read_counts_per_chr[['ah8218spike-gh2ax-chip_trimmed']],
           read_counts_per_chr[['ah8218spike-gh2ax-inp_trimmed']]),
  AH8220=c(read_counts_per_chr[['ah8220spike-gh2ax-chip_trimmed']],
           read_counts_per_chr[['ah8220spike-gh2ax-inp_trimmed']]),
  AH7011=c(read_counts_per_chr[['ah7011spike-gh2ax-chip_trimmed']],
           read_counts_per_chr[['ah7011spike-gh2ax-inp_trimmed']]),
  AH8219=c(read_counts_per_chr[['ah8219spike-gh2ax-chip_trimmed']],
           read_counts_per_chr[['ah8219spike-gh2ax-inp_trimmed']]),
  AH4206=c(read_counts_per_chr[['ah4206spike-gh2ax-chip_trimmed']],
           read_counts_per_chr[['ah4206spike-gh2ax-inp_trimmed']])
)

# Define reference (WT strain)
WT_chip_counts <- files_for_calculation[['AH119']][1]
WT_input_counts <- files_for_calculation[['AH119']][2]
...
names(bedtools_pileups)[
  str_detect(bedtools_pileups, fixed('ah119', ignore_case=TRUE))]

# List of samples ordered correctly
files_for_calculation <- list(
  AH119=c(bedtools_pileups[['ah119spike-gh2ax-chip']],
          bedtools_pileups[['ah119spike-gh2ax-inp']]),
  AH8218=c(bedtools_pileups[['ah8218spike-gh2ax-chip']],
           bedtools_pileups[['ah8218spike-gh2ax-inp']]),
  AH8220=c(bedtools_pileups[['ah8220spike-gh2ax-chip']],
           bedtools_pileups[['ah8220spike-gh2ax-inp']]),
  AH7011=c(bedtools_pileups[['ah7011spike-gh2ax-chip']],
           bedtools_pileups[['ah7011spike-gh2ax-inp']]),
  AH8219=c(bedtools_pileups[['ah8219spike-gh2ax-chip']],
           bedtools_pileups[['ah8219spike-gh2ax-inp']]),
  AH4206=c(bedtools_pileups[['ah4206spike-gh2ax-chip']],
           bedtools_pileups[['ah4206spike-gh2ax-inp']])
)

# Define reference (WT strain)
WT_chip_pileups <- files_for_calculation[['AH119']][1]
WT_input_pileups <- files_for_calculation[['AH119']][2]
...
peaks <- import_bedGraph(here(
  'data/MACS2_peaks/AH4206spike-gh2ax-ChIP_011618_trimmed_S288c_SK1_Yue_PM_peaks.narrowPeak'))
...
#   'data/spikein_normalization_factors_using_different_methods_for_gH2AX.csv'))
